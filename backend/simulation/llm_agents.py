...
class LLMAgent:
    ...
    def build_prompt(
        ...
        prompt = AGENT_PROMPT_TEMPLATE.format(
            ...
            personality=self.persona.get("personality", "未指定"),
            media_habit=self.persona.get("media_habit", "未指定"),
            social_style=self.persona.get("social_style", "未指定"),
            authority_stance=self.persona.get("authority_stance", "未指定"),
