...
{{"new_opinion": 数值在-1到1之间, "reasoning": "简短理由(20字内)", "emotion": "情绪状态(冷静/愤怒/焦虑/怀疑/释然)", "action": "行动选择(转发/评论/观望/辟谣)", "generated_comment": "如果选择评论，生成的评论内容(30字内)"}}
"""
...
class LLMAgent:
    ...
    async def decide_opinion(
        ...
        """
        prompt, received_news = self.build_prompt(neighbor_opinions, debunk_released, cocoon_strength)
